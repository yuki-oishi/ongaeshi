...
function the_dp_footer_logo(){
  ...
  $url = home_url();
  if($logo){
    echo '<h3 id="footer_logo_image" style="top:' . $option['logotop2'] . 'px; left:' . $option['logoleft2'] . 'px;"><a href=" ' . $url . '/" title="' . $title . '"><img src="' . $logo['url'] . '?' . time() . '" alt="' . $title . '" title="' . $title . '" /></a></h3>' . "\n";
  } else {

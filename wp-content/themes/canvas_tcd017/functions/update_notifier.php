	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="http://tcd-wp.net/dl017/canvas/canvas_tcd017.zip">最新版のテーマをダウンロードする</a> 】</p>
          <div id="mono_info">
	   <h3>更新情報</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_canvas.xml';
	
	$db_cache_field = 'canvas-contempo-notifier-cache';
	$db_cache_field_last_updated = 'canvas-contempo-notifier-last-updated';
